...
const Dashboard = () => {
  ...
  return (
    <>
      {user &&
        <div className="w-full flex flex-col md:flex-row justify-center items-center md:items-start pt-20 pb-5">
          {/* Board */}
          ...
          <div className='flex justify-center flex-col md:flex-row'>
            <div className='w-full bg-[#333333CC] rounded-md m-2 min-h-[500px] md:min-w-[33vw] max-w-[90vw] md:max-w-[500px]'>
